        ...
        <div class="container">
            <div class="row align-items-center">
                ...
                <div class="col-md-6">
                    ...
                    <a href="{{ $aboutPages?->button_link ?? '#' }}" class="btn btn-primary mt-2">{{ $aboutPages?->button_text ?? 'Read More' }}</a>
                </div>
            </div>
        </div>
    </section>
        ...
        <div class="container">
            <div class="row text-center">
                <div class="col-md-4 mb-4">
                    ...
                    <p class="text-muted">{{ $aboutPages?->our_mission ?? 'To become the most trusted and preferred online shopping destination globally.' }}</p>
                </div>
                <div class="col-md-4 mb-4">
                    <i class="fas fa-eye fa-3x text-primary mb-3"></i>
                    <h4 class="font-weight-light">Our Vision</h4>
                    <p class="text-muted">{{ $aboutPages?->our_vision ?? 'To revolutionize the way people shop online by providing a seamless and enjoyable shopping experience.' }}</p>
                </div>
                <div class="col-md-4 mb-4">
                    <i class="fas fa-gem fa-3x text-primary mb-3"></i>
                    <h4 class="font-weight-light">Our Values</h4>
                    <p class="text-muted">{{ $aboutPages?->our_values ?? 'Integrity, Innovation, and Customer Satisfaction.' }}</p>
                </div>
            </div>
        </div>
    </section>
        ...
        <div class="container">
            ...
            <div class="row text-center">
                ...
                <div class="col-md-4 mb-4 team-member">
                    <img src="{{ Storage::url($teamMember?->media?->src) }}" alt="Team Member 1" class="img-fluid shadow-sm">
