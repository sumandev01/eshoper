    ...
    <div class="px-2">
        ...
        <div class="d-flex align-items-center justify-content-between mb-2">
            <input type="text" id="min-price"
                class="form-control form-control-md bg-primary text-center me-2 text-white" readonly>
            <span class="text-muted">-</span>
            <input type="text" id="max-price"
                class="form-control form-control-md bg-primary text-center ms-2 text-white" readonly>
        </div>
    </div>
</div>
