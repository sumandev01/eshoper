<div class="col-12 pb-1">
    <div class="d-flex align-items-center justify-content-between mb-4 p-3 rounded" style="background-color: var(--primary-soft);">
        <form onsubmit="return false;" class="flex-grow-1 me-4 position-relative">
            <input type="text" id="search-product" class="form-control rounded-pill ps-4 pe-5 border-0 shadow-sm" placeholder="Search by Product Name..."
                value="{{ request('search') }}" style="height: 45px; transition: all 0.3s;" onfocus="this.style.boxShadow='0 0 0 0.25rem rgba(var(--primary-rgb), 0.25)'">
