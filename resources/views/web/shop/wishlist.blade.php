    ...
    <div class="container pt-1">
        <div class="row">
            <div class="col-md-12 table-responsive mb-5">
                ...
                <table class="table table-borderless table-hover text-center mb-0 theme-shadow rounded" id="wishlistTable" style="border-collapse: separate; border-spacing: 0;">
                            ...
                            <tr data-item-id="{{ $item?->id }}">
                                ...
                                <td class="align-middle">
                                    @if ($item?->product?->stock > 0)
                                        <span class="badge p-2 rounded" style="background-color: color-mix(in srgb, #198754 15%, white); color: #198754; font-weight: 600;">In Stock</span>
                                    @else
                                ...
                                <td class="align-middle">
                                    <a href="{{ route('wishlist.remove', $item->id) }}"
                                        class="btn btn-sm shadow-sm deleteBtn" style="background-color: color-mix(in srgb, red 12%, white); color: red; border: none;">
