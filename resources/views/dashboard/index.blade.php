                    ...
                    <div class="table-responsive">
                        <table class="table">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td>
                                        <img src="{{ asset('dashboard/assets/images/faces/face2.jpg') }}" class="me-2"
                                ...
                                <tr>
                                    <td>
                                        <img src="{{ asset('dashboard/assets/images/faces/face3.jpg') }}" class="me-2"
                                ...
                                <tr>
                                    <td>
                                        <img src="{{ asset('dashboard/assets/images/faces/face4.jpg') }}" class="me-2"
                                            alt="image"> John Doe
                                    </td>
