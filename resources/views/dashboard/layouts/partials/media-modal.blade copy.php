...
@push('scripts')
    <script>
        ...
        $(document).ready(function() {
            ...
            $('#file-input').on('change', function() {
                ...
                Array.from(files).forEach((file, index) => {
                    if (file.size > 2 * 1024 * 1024) {
                        ...
                        // 2. Append Error Alert Message
                        errorContainer.append($errorAlert);

                        // 3. Remove Error Alert Message
                        // After 3 seconds, the error alert will be removed
                        setTimeout(function() {
            ...
            // 7. Confirm Selection (Display preview on main page) - FIXED ARRAY ISSUE
            $('.confirm-selection-btn').on('click', function() {
                ...
                // আমরা ডাইনামিকভাবে 'product_gallery_id_2' এর মতো নাম তৈরি করব
            ...
            // 8. Remove image from main page preview - FIXED TO HANDLE DELETED LIST
            $(document).on('click', '.remove-image-btn', function() {
                ...
                const baseInputName = targetId.replace(/-/g, '_');

                // ১. যদি এটি ডাটাবেস থেকে আসা পুরাতন ডাটা হয় (Existing List আপডেট করা)
                ...
                // ২. ডিলিটেড লিস্ট আপডেট করা (আপনার রিকয়ারমেন্ট অনুযায়ী)
                ...
                // ৩. সব ছবি রিমুভ হয়ে গেলে প্লেসহোল্ডার দেখানো
