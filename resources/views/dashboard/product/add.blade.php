            ...
            <div class="row mt-3">
                ...
                <div class="col-lg-8">
                    <div class="card mb-4 shadow-sm">
                        ...
                        <div class="card-body">
                            <x-input name="name" label="Product Name" type="text" placeholder="Enter product name" :required="false" :maxlength="100" :value="$item->name ?? ''" />

                            <x-input name="slug" label="Product Slug" type="text" placeholder="enter-product-slug" :required="false" :maxlength="100" :value="$item->slug ?? ''" />
                            ...
                            <x-textarea name="short_description" label="Short Description" :editor="false" :value="old('short_description')" placeholder="Write something..." maxlength="500" :wordcount="true" rows="5" :required="false" />

                            <x-textarea name="description" label="Description" :editor="true" :value="old('description')"  placeholder="Write something..." maxlength="1500" :wordcount="true" rows="5" :required="false" />

                            <x-textarea name="specifications" label="Specifications" :editor="true" :value="old('specifications')" placeholder="Write something..." maxlength="1500" :wordcount="true" rows="5" :required="false" />
                        </div>
                    </div>
                    ...
                    <div class="card mb-4 shadow-sm">
                        ...
                        <div class="card-body">
                            <div class="row">
                                <div class="col-md-6 mb-3">
                                    <x-input name="sale_price" type="number" placeholder="0.00" :inputGroup="true" inputGroupText="৳" label="Sale Price" />
                                </div>
                                <div class="col-md-6 mb-3">
                                    <x-input name="discount" type="number" placeholder="0.00" :inputGroup="true" inputGroupText="৳" label="Discount Price" />
                                </div>
                                <div class="col-md-6 mb-3">
                                    <x-input name="buy_price" type="number" placeholder="0.00" :inputGroup="true" inputGroupText="৳" label="Buy Price" />
                                </div>
                                <div class="col-md-6 mb-3">
                                    <x-input name="tax" type="number" placeholder="0.00" :inputGroup="true" inputGroupText="%" label="Tax" />
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="card mb-4 shadow-sm">
                        ...
                        <div class="card-body">
                            <x-media-gallery target_id="product_galleries" name="galleries" :required="false" limit="10" button_class="mt-2" />
                        </div>
                    </div>
                </div>
                ...
                <div class="col-lg-4">
                    <div class="card mb-4 shadow-sm">
                        ...
                        <div class="card-body">
                            ...
                            <x-select name="sub_category_id" id="sub_category_id" label="Subcategory" :options="$subCategories ?? []" placeholder="Select Subcategory" />
