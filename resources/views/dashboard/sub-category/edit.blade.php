                ...
                <form action="{{ route('admin.sub-category.update', $subCategory->id) }}" method="post"
                    ...
                    <div class="card-header pt-4">
                        <div class="card-title d-md-flex justify-content-between align-items-center">
                            ...
                            <a href="{{ route('admin.sub-category.index') }}" class="btn btn-primary mr-2 btn-icon-text">
                    ...
                    <div class="card-body px-4 pb-0">
                        ...
                        <x-select label="Category" name="category_id" id="category_id" :options="$categories"
                            value="{{ $subCategory?->category_id ?? '' }}" placeholder="Select Category" />
                        <x-media-thumbnail label="Image" input_name="media_id" :existing_image="$subCategory->thumbnail" 
                            :existing_id="$subCategory->media_id" />
                    </div>
                    <div class="card-footer pb-4 pt-3">
                        ...
                        <a href="{{ route('admin.sub-category.index') }}" class="btn btn-danger btn-icon-text mt-2">
