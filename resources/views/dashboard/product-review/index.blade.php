...
@section('title', ($siteSettings->site_title ?? null) . ' - ' . 'Product Reviews')
@section('content')
    <div class="row">
        <div class="col-12 grid-margin stretch-card">
            <div class="card">
                <div class="card-header py-3">
                    ...
                    <p class="mb-0 text-muted">List of all product reviews</p>
                </div>
        ...
        <div class="modal-dialog modal-md">
            <div class="modal-content p-0">
                <div class="modal-header bg-primary text-white">
                    <h5 class="modal-title" id="viewCommentModalLabel">View Review</h5>
    ...
    <div class="modal fade" id="editCommentModal" tabindex="-1" aria-labelledby="editCommentModalLabel"
        ...
        <div class="modal-dialog modal-md">
            <div class="modal-content p-0">
                <div class="modal-header bg-primary text-white">
                    <h5 class="modal-title" id="editCommentModalLabel">Edit Review Status</h5>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>
    ...
    <script>
        $(document).ready(function() {
            ...
            $('#editCommentModal').on('show.bs.modal', function(e) {
                ...
                let url = "{{ route('admin.product-review.update', ':id') }}";
