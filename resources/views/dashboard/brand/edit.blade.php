...
@section('title', ($siteSettings->site_title ?? null) . ' - ' . 'Edit Brand - ' . $brand?->name)
@section('content')
    <div class="row">
                ...
                <form action="{{ route('admin.brand.update', $brand?->id) }}" method="post" enctype="multipart/form-data">
                    ...
                    <div class="card-header py-4">
                        <div class="card-title d-md-flex justify-content-between align-items-center">
                            ...
                            <a href="{{ route('admin.brand.index') }}" class="btn btn-sm btn-primary mr-2 btn-icon-text">
                    ...
                    <div class="card-body px-4 pb-0">
                        ...
                        <x-media-thumbnail label="Image" input_name="media_id" :existing_image="$brand->thumbnail" :existing_id="$brand->media_id" :required="true" />
                    </div>
                    <div class="card-footer pb-4 pt-3 text-end">                        
                        <a href="{{ route('admin.brand.index') }}" class="btn btn-sm btn-secondary btn-icon-text mt-2">
